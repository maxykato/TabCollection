...
SWIFT_CLASS("_TtC13TabCollection11AppDelegate")
...
SWIFT_CLASS("_TtC13TabCollection22MainCollectionViewCell")
...
SWIFT_CLASS("_TtC13TabCollection21TabCollectionViewCell")
@interface TabCollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified tabTitle;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13TabCollection14ViewController")
...
@property (nonatomic, weak) IBOutlet UICollectionView * __null_unspecified tabCollectionView;
@property (nonatomic, weak) IBOutlet UICollectionView * __null_unspecified mainCollectionView;
@property (nonatomic) NSInteger activeTabNumber;
- (void)viewDidLoad;
...
- (void)moveTabsBySwipe:(UIScrollView * __nonnull)scrollView;
